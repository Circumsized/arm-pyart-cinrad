...
Reader for Chinese S-band (CINRAD-SA) Level II files.

Note: the parser decodes the base (single-polarization) moments REF/VEL/SW and
recognizes the dual-polarization moments ZDR/PHI/RHO when present in the
message blocks. Dual-polarization decoding should be validated against real
CINRAD-SA dual-polarization files.
