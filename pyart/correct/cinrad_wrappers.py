...
def dualpol_qc(radar, band='C', write_back=True, clear_air_mode='label',
               use_existing_kdp=True, **kwargs):
    """
    ...
    if phidp is None and kdp is None:
        raise ValueError('Dual-polarization QC requires a differential_phase '
    ...
    for sweep in range(radar.nsweeps):
        ...
        res = run_dualpol_qc(
            ...
            dr=dr, band=band, use_existing_kdp=use_existing_kdp,
            clear_air_mode=clear_air_mode, **kwargs)
        results.append(res)
